...
export const metadata: Metadata = {
  ...
  category: "technology",
  keywords: ["JSON tools", "frontend tools", "image tools", "video tools", "M3U8 player", "HLS player", "developer tools", "URL parser", "redirect checker", "JSON converter", "image compressor", "photo collage maker"],
  ...
  openGraph: {
    ...
    description: "29 private browser-based tools for JSON, frontend data, images, video and developer workflows.",
    images: [{ url: "/og.jpg", width: 1536, height: 1024, alt: "XXF JSON and frontend conversion toolbox" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "XXF Tools — JSON in. Frontend-ready out.",
    description: "29 private browser-based JSON, frontend, image and video tools.",
    images: ["/og.jpg"],
  },
