...
export const metadata: Metadata = {
  ...
  category: "technology",
  keywords: ["JSON tools", "frontend tools", "image tools", "developer tools", "URL parser", "redirect checker", "JSON converter", "image compressor", "photo collage maker"],
  ...
  openGraph: {
    ...
    description: "28 private browser-based tools for JSON, frontend data, images and developer workflows.",
    images: [{ url: "/og.jpg", width: 1536, height: 1024, alt: "XXF JSON and frontend conversion toolbox" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "XXF Tools — JSON in. Frontend-ready out.",
    description: "28 private browser-based JSON, frontend and image tools.",
    images: ["/og.jpg"],
  },
