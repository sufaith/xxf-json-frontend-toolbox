...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "en_US", siteName: "XXF Tools", url: "https://xxf.app/animal/", title: "Prehistoric Animal Museum — XXF", description: "A calm, interactive browser museum for exploring 18 prehistoric animals.", images: [{ url: "/animal-museum-hero.jpg", width: 1536, height: 1024, alt: "Prehistoric animal museum exhibit" }] },
  twitter: { card: "summary_large_image", title: "Prehistoric Animal Museum — XXF", description: "Explore 18 prehistoric animals in a calm browser museum.", images: ["/animal-museum-hero.jpg"] },
};
