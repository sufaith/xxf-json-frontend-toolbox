...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { type: "article", url: `https://xxf.app/guides/${guide.slug}/`, title: guide.title, description: guide.description, publishedTime: guide.updated, modifiedTime: guide.updated, images: ["/og.png"] },
