    ...
    <main>
      ...
      <article className="article-shell">
        ...
        <div className="article-body">
          ...
          <footer className="article-review-note">Implementation-checked by the XXF Tools editorial team · <Link href="/editorial-policy/">Review standards</Link></footer>
        </div>
      </article>
    </main>
  );
